...
export default function Subject({ data }) {
  return (
    ...
    <div
      ...
      className={`bg-red-700 outline outline-red-700 outline-[0.1rem] rounded-sm md:rounded-md bg-opacity-50 text-red-100 p-[0.1rem] md:p-2 overflow-hidden m-[.1rem] $`}
    >
